...
const UnoCard4w: React.FC<UnoWildCardProps> = ({ size }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M111 141H91C85.4772 141 79.8449 145.043 78.4201 150.03L63.5799 201.97C62.155 206.957 65.4771 211 70.9999 211H90.9999C96.5228 211 102.155 206.957 103.58 201.97L118.42 150.03C119.845 145.043 116.523 141 111 141Z"
        fill="#FF5555"
      />
      <path
      ...
      />
      <path
        d="M151 111H131C125.477 111 119.845 115.043 118.42 120.03L103.58 171.97C102.155 176.957 105.477 181 111 181H131C136.523 181 142.155 176.957 143.58 171.97L158.42 120.03C159.845 115.043 156.523 111 151 111Z"
        fill="#5555FF"
      />
      <path
      ...
      />
      <path
        d="M141 171H121C115.477 171 109.845 175.043 108.42 180.03L93.5799 231.97C92.155 236.957 95.4771 241 101 241H121C126.523 241 132.155 236.957 133.58 231.97L148.42 180.03C149.845 175.043 146.523 171 141 171Z"
        fill="#FFAA00"
      />
      <path
      ...
      />
      <path
        d="M181 141H161C155.477 141 149.845 145.043 148.42 150.03L133.58 201.97C132.155 206.957 135.477 211 141 211H161C166.523 211 172.155 206.957 173.58 201.97L188.42 150.03C189.845 145.043 186.523 141 181 141Z"
        fill="#55AA55"
      />
    </svg>
  );
